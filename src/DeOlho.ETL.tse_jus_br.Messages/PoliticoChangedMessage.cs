...
namespace DeOlho.ETL.tse_jus_br.Messages
{
    public class PoliticoChangedMessage : EventBusMessage
    {
        public PoliticoChangedMessage(string messageId, List<Politico> politicos) : base(messageId)
        {
            Politicos = politicos;
        }

        public List<Politico> Politicos { get; private set; }
